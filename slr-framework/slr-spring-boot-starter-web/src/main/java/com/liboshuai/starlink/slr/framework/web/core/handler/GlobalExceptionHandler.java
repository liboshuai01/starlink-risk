package com.liboshuai.starlink.slr.framework.web.core.handler;
...
import static com.liboshuai.starlink.slr.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
public class GlobalExceptionHandler {
    ...
    private CommonResult<?> handleTableNotExists(Throwable ex) {
        ...
        log.error("表不存在异常：{}",message);
        return CommonResult.error(NOT_TABLE.getCode(), message);
    }
